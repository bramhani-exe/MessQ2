      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            {/* Data source: SIMULATED vs ESP32 LIVE (Model A) */}
            {dataSource === 'ESP32_LIVE' ? (
              <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-full bg-cyan-950 border border-cyan-500/50 text-cyan-300">
                ESP32 LIVE • IR-01 ENTRY / IR-02 EXIT
              </span>
            ) : (
